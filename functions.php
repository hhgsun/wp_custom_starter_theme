...
function hhgsun_scripts() {
	...
	wp_enqueue_script( 'hhgsun-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
 ...
 * Custom files: hhgsun
 */
require get_template_directory() . '/inc/custom-dash.php'; // custom panel
// THEME DASH PAGE
// include('inc/dash-theme.php');
